<?php get_header(); ?>
<!-- content goes here hello web-package-->
<div class="row">
...
<div class="questions">
  <?php $query = new WP_Query( 'order=asc&category_name=web-packages-faq&post_type=faq&post_status=publish&paged='. get_query_var('paged')); ?>
